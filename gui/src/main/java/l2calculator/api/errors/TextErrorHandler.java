 ...
 * to customize error handling of HTTP responses returned by the backend l2calculator.API.
 *
 * <p>
...
public class TextErrorHandler extends DefaultResponseErrorHandler {
    ...
    public void handleError(ClientHttpResponse response) throws IOException {
        try {
            ...
            throw new ApiException("Unexpected error occurred while reading error response.", response.getStatusCode());
        }
    }
}
